# hmo_registry/cities/south_oxfordshire.py
"""
South Oxfordshire District Council HMO Data Source
...
class SouthOxfordshireHMOData(BaseHMODataSource):
    """South Oxfordshire HMO registry data source"""
    
    def __init__(self):
        super().__init__('south_oxfordshire')
        self.display_name = 'South Oxfordshire District Council'
        self.source_url = 'https://www.southoxon.gov.uk/'
    
    def load_raw_data(self) -> List[Dict]:
        """Load South Oxfordshire HMO data from database"""
        
        logger.info(f"Loading {self.city_name} HMO data from database...")
        
        db = SessionLocal()
        try:
            # Query database for South Oxfordshire records
